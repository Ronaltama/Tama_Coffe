...
@media (max-width: 768px) {
  ...
  .space-y-8 {
    space-y: 1.5rem !important; /* Tailwind utility override if needed, but better to just use margin/padding */
    margin-bottom: 2rem;
  }
  ...
  .overflow-x-auto {
    margin-right: -1rem; /* Pull to edge if needed, but default is usually fine */
  }
}
</style>
