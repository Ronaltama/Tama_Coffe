<template>
  <div class="bg-neutral-50 min-h-screen flex flex-col">
    <div class="max-w-md mx-auto bg-white w-full min-h-screen flex flex-col relative shadow-xl">

      <!-- Header -->
      <header class="bg-white border-b border-gray-100 flex-none sticky top-0 z-20">
      ...
      <main class="flex-1 overflow-y-auto">
        ...
        <div v-if="cartItems.length > 0" class="p-4">
          <!-- Items Section -->
          <div class="mb-6">
            <h2 class="text-sm font-bold text-gray-500 uppercase tracking-wide mb-4">Items</h2>
            ...
            <div class="space-y-3">
              ...
              > 
                <!-- Product Image -->
                <div class="w-20 h-20 rounded-xl overflow-hidden flex-shrink-0 bg-gray-50">
                  <img 
                    :src="item.imageUrl" 
                    :alt="item.name" 
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p v-if="item.variant !== 'food'" class="text-xs text-gray-500 mb-2">
                    {{ item.variant }}
                  </p>
                  <p class="text-base font-bold text-gray-900">Rp{{ formatPrice(item.price) }}</p>
                </div>
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-base font-bold text-gray-900 w-8 text-center">{{ item.quantity }}</span>
          ...
          <!-- Notes Section -->
          <div class="mb-6">
            <h2 class="text-sm font-bold text-gray-500 uppercase tracking-wide mb-4">Notes</h2>
        ...
        <div v-else class="h-full flex flex-col items-center justify-center text-center p-8 -mt-10">
          ...
          <p class="text-gray-500 text-sm mb-6 max-w-xs">You haven't added any items yet.</p>
          <router-link 
            :to="`/order/${tableId}/menu`" 
