  ...
  <div class="bg-neutral-100 min-h-screen">
    <div class="max-w-md mx-auto bg-white min-h-screen font-sans">
      ...
      <div v-else-if="error" class="flex flex-col justify-center items-center min-h-screen px-4">
        ...
        <router-link :to="`/order/${tableId}/menu`"
      ...
      <template v-else-if="product">
        ...
        <section class="relative">
          <img :src="product.imageUrl" :alt="product.name" class="w-full h-80 object-cover" @error="handleImageError" />
...
// Terima tableId dan product id sebagai prop
...
const getProductImageUrl = (imagePath) => {
  if (!imagePath) return 'https://images.unsplash.com/photo-1517487881594-2787fef5ebf7?w=800&q=80';
  ...
  try {
    ...
    if (existingItemIndex !== -1) {
      ...
      const newItem = {
        ...
        imageUrl: getProductImageUrl(product.value.image),
