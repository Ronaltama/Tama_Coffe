      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <div v-for="table in tables" :key="table.id"
          ...
          <div class="absolute top-4 right-4 z-10">
            <span class="px-3 py-1.5 rounded-full text-xs font-bold text-white shadow-lg" :class="{
          ...
          <div class="p-6">
            <div class="mb-4 flex justify-center">
              <div
                class="w-20 h-20 bg-gradient-to-br from-orange-400 to-amber-500 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="mt-6 text-center">
              ...
              <div v-else-if="table.status === 'occupied'" class="text-gray-500 font-medium">
                Sedang digunakan
              </div>
              <div v-else-if="table.status === 'maintenance'" class="text-gray-500 font-medium">
                Dalam perbaikan
              </div>
          ...
          <div
            class="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-orange-400 to-amber-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300">
          </div>
        </div>
      </div>
