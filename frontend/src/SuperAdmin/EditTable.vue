...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await axios.put(`${API_BASE}/tables/${tableId}`, payload)
  ...
  <div class="flex-1 overflow-auto font-inter">
    <div class="p-8 max-w-4xl mx-auto">
      ...
      <div class="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 class="text-color-azure-11 text-4xl font-bold font-inter leading-tight">Edit Table</h1>
          <p class="text-color-grey-46 text-sm mt-1">Update table information</p>
        </div>
      </div>
      ...
      <div v-if="fetching" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-16 text-center">
        <div class="inline-flex items-center gap-3">
          ...
          <div class="text-color-grey-46 text-sm font-medium">Loading table data...</div>
        </div>
      </div>
