...
const renderChart = () => {
  console.log("renderChart called, chartCanvas:", chartCanvas.value);
...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 lg:p-8"
  >
    <div class="max-w-7xl mx-auto space-y-8">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="hidden lg:flex items-center gap-3">
          <div
            class="bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200"
          >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="flex items-start justify-between">
            ...
            <div
              class="bg-white/20 backdrop-blur-sm p-3 rounded-xl group-hover:bg-white/30 transition-all"
            >
              <svg
      ...
      <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <div class="p-6">
          <!-- Sales Chart -->
          <div
            class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 mb-8"
            style="height: 320px"
          >
                  ...
                  >
                    <td class="py-4 px-6">
                      <div class="flex items-center gap-3">
                        <div
                          class="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-amber-400 to-amber-600 text-white font-bold text-sm"
                        >
                          {{ idx + 1 }}
                        </div>
            ...
            <table class="w-full min-w-[640px]">
              ...
              <tbody class="bg-white divide-y divide-gray-100">
                ...
                >
                  ...
                  <td class="py-4 px-6">
                    <span
                      class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-pink-100 text-pink-700"
                    >
                      <svg
                  ...
                  <td class="py-4 px-6">
                    ...
                    >
                      <span
                        class="h-2 w-2 rounded-full bg-green-500 mr-2 animate-pulse"
                      ></span>
                      Active
                    </span>
                  </td>
