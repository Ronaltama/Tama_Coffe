...
const fetchOrderDetail = async () => {
    try {
        ...
        Swal.fire({
            ...
            router.push("/superadmin/history");
        });
    } finally {
        loading.value = false;
    }
    ...
    <div class="min-h-screen bg-gray-50 print:bg-white">
        ...
        <div v-else-if="orderData" class="max-w-4xl mx-auto p-6">
            ...
            <div class="flex items-center justify-between mb-6 print:hidden">
                <button @click="router.push('/superadmin/history')"
        ...
        <div v-else class="flex items-center justify-center min-h-screen">
            <div class="text-center">
                ...
                <button @click="router.push('/superadmin/history')" class="text-orange-600 hover:underline">
