...
<div class="max-w-3xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Add Table</h1>
    </div>

    <!-- Form -->
    <form action="{{ route('superadmin.tables.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
